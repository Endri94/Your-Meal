...
// 4й бургер в корзине счетчик
let minus4 = document.getElementById("minus4"), countminus4 = 0;
let number4 = document.getElementById("count4");
let plus4 = document.getElementById("plus4"), countplus4 = 0;


minus4.onclick = function () {
  countminus4 -= 1;
  number4.innerHTML = countminus4 + countplus4;
};
